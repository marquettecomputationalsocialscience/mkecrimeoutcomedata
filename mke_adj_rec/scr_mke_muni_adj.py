...
def scr_mke_muni_adj(c_no):
    ...
    try:
        ...
        print(c_no, ' entered @ ', datetime.time(datetime.now()))
        ...
        print(c_no, ' entered, but has conflicts @ ', datetime.time(datetime.now()))

    if c_no < 17080000:

        scr_mke_muni_adj(c_no + 1)
